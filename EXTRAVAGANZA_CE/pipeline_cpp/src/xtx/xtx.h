...
// Step 4: translate the .xtx config files.
//
...
// (JP, EN) pairs matched against a WHOLE comma field, never a substring.
// On a duplicate JP key the first pair wins, so order decides the winner.
