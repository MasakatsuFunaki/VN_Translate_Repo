...
// <game>\spt_backup when present, else <game>\spt: once the repack step has
// run, the backup is the only copy that still holds the pristine scripts, so
// re-extracting must read from there.
