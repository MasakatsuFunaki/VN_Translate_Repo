# Conan 2 recipe for the EXTRAVAGANZA_CE translation pipeline (C++ port of the
# former Python scripts 00..05).
#
...
class ExtravaganzaCePipeline(ConanFile):
    name = "extravaganza_ce_pipeline"
    version = "1.0.0"
    package_type = "application"
    description = "EXTRAVAGANZA CE English translation pipeline"
