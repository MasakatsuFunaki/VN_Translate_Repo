# Conan 2 recipe for the amakano2pe proxy DLL (winmm.dll).
#
...
# DLL is injected into the 32-bit cs2.exe process.
#
...
class Amakano2PeProxy(ConanFile):
    name = "amakano2pe_proxy"
    version = "1.0.0"
    package_type = "shared-library"
    description = "Amakano 2 ~Perfect Edition~ winmm.dll proxy (runtime text hook)"
