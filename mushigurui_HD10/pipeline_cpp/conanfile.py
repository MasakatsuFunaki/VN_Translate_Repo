# Conan 2 recipe for the mushigurui_HD10 translation pipeline (C++ port of the
...
class MushiguruiPipeline(ConanFile):
    name = "mushigurui_pipeline"
    version = "1.0.0"
    package_type = "application"
    description = "Mushigurui HD10 English translation pipeline"
    ...
    def requirements(self):
        ...
        # + rasterisation) and stb replaces PIL Image (PNG/BMP/JPEG codecs).
