...
// Step 4: translate .xtx config files.
//
...
// Insertion-ordered (JP, EN) pairs: substitution walks them in order, so a
// longer name must precede any name that is a prefix of it.
