...
//
// Every app resolves its inputs and outputs relative to the project folder,
// which is found at run time (see default_project_dir) and overridable with
// `--dir <path>`, plus `--game-dir <path>` for the game installation
// (default C:\Games\mushigurui_HD10).
#pragma once
...
inline po::options_description common_options(std::string& project_dir,
    ...
    desc.add_options()
        ...
        ("dir", dir, "mushigurui_HD10 project folder")
        ("game-dir", po::value(&game_dir)->default_value("C:\\Games\\mushigurui_HD10"),
