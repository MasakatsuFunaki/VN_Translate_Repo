...
// Chars per line at fontSize=16 -- narrowed 30% from 87 for less head movement.
constexpr int MAX_LINE_CHARS = 61;
// Max lines per text block; the proxy DLL patches windowMessageNumber 4 -> 6.
