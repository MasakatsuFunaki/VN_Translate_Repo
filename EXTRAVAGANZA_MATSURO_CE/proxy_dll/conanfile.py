# Conan 2 recipe for the EXTRAVAGANZA MATSURO CE proxy DLL (winmm.dll).
#
...
# DLL is injected into the 32-bit BLACKCyc game process.
#
...
class ExtravaganzaMatsuroProxy(ConanFile):
    name = "extravaganza_matsuro_proxy"
    version = "1.0.0"
    package_type = "shared-library"
    description = "EXTRAVAGANZA MATSURO CE winmm.dll proxy (runtime text hook)"
